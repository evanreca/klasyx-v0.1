...
-- Forward Engineered from an EER Diagram via MySQL Workbench
...
INSERT INTO songs (/*song_id, title, release_year, song_length, filepath, composers_composer_id*/) VALUES
(DEFAULT, 'Introduction and Rondo Cappricioso', 1863, '9:15', 'introduction_and_rondo_cappricioso.wav', 1 );

INSERT INTO accounts_history (/*accounts_history_id, accounts_account_id, songs_song_id, time_song_listened*/) VALUES
(1, 1, 1, '2020-11-11 12:15:13');
